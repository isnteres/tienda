...
<?php require('./layout/heaproductos.php') ?>
    ...
    <main>
        <div class="product-container">
            ...
            <div class="product">
                <img src="imagenes/Aceituna.jpg" alt="Pan Serranito" width="150">
                <p>Pan serranito</p>
            ...
            <div class="product">
                <img src="imagenes/cabanossiyqueso" alt="Pan con Cabanossi y Queso" width="150">
                <p>Pan con Aceituna</p>
                <p class="price">S/ 2.50</p>
                <button class="button-1">Agregar</button>
            </div>
            ...
            <div class="product">
                <img src="imagenes/chocolate" alt="Pan con Chocolate y Pecanas" width="150">
                <p>Pan con Aceituna</p>
                <p class="price">S/ 2.50</p>
                <button class="button-1">Agregar</button>
            </div>
        ...
        <div class="product">
            ...
            <div class="product">
                <img src="imagenes/ccc.jpg" alt="Chanco 1/4" width="150">
                <p>Chanco 1/4</p>
